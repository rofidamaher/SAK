...
Background:user could click on POA_SPECIAL
  ...
  Scenario: user could add new transactions for SALE_COMPANY
    ...
    When user add the first Party with obj of index "13" and id of index "1" id "00000000081" txtPercentFristParty "10" txtBayanatElwkalaFirstParty "54/2014" and click on chkDepositFirstParty
