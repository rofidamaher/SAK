...
Feature: F06_05_SALE_SHARE_COMMERCIAL_REGISTRATION | users could add new transactions for SALE_SHARE_COMMERCIAL_REGISTRATION
Background:user could click on SALE_SHARE_COMMERCIAL_REGISTRATION
 ...
 #  بيع حصص رخصة تجارية
  ...
  Scenario: user could add new transactions for SALE_SHARE_COMMERCIAL_REGISTRATION
     # عن نفسه      |||  رقم شخصي
    ...
    When user enter SalePermitNoCompany "1414" SALE_PERMIT_VALUE_COMPANY "2145" SALE_PERMIT_NO_APPROVAL_LETTER_COMPANY "748" and click on add btn
