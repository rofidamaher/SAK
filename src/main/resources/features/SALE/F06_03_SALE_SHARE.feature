...
Background:user could click on SALE_SHARE
  ...
  Scenario: user could add new transactions for SALE_COMPANY
    ...
    When user select person has id "00000000215" soldValue "5" and click on save btn
    ...
    When user enter SALE_COMMERICAL_NO_STOCKS "230" date Y "2029" M "Jul" D "15" SALE_VALUE_STOCKS "555" and click on add btn
